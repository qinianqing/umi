      ...
      <React.Fragment>
        <Row gutter={24}>
          ...
          <Col xl={6} lg={24} md={24} sm={24} xs={24}>
            ...
            <Card
              title={<FormattedMessage id="monitor.monitor.efficiency" defaultMessage="Efficiency" />}
              style={{ marginBottom: 24 }}
              bodyStyle={{ textAlign: 'center' }}
              bordered={false}
            >
              <Gauge
                title={formatMessage({ id: 'monitor.monitor.ratio', defaultMessage: 'Ratio' })}
                height={180}
                percent={87}
              />
            </Card>
              ...
              <Row style={{ padding: '16px 0' }}>
                <Col span={8}>
                  <Pie
                    ...
                    percent={28}
                    subTitle={
                      <FormattedMessage id="monitor.monitor.fast-food" defaultMessage="Fast food" />
                    }
                    total="28%"
                    height={128}
                    lineWidth={2}
          ...
          <Col xl={6} lg={12} sm={24} xs={24} style={{ marginBottom: 24 }}>
            ...
            >
              <WaterWave
                height={161}
                title={
                  <FormattedMessage id="monitor.monitor.fund-surplus" defaultMessage="Fund Surplus" />
                }
                percent={34}
              />
            </Card>
